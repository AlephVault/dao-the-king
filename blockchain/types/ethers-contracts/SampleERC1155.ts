...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener, TypedContractMethod } from "./common.js"
  ...
  export interface SampleERC1155Interface extends Interface {
    getFunction(nameOrSignature: "GOLD_BADGE" | "SILVER_BADGE" | "balanceOf" | "balanceOfBatch" | "isApprovedForAll" | "mint" | "mintBatch" | "owner" | "renounceOwnership" | "safeBatchTransferFrom" | "safeTransferFrom" | "setApprovalForAll" | "supportsInterface" | "transferOwnership" | "uri"): FunctionFragment;

    getEvent(nameOrSignatureOrTopic: "ApprovalForAll" | "OwnershipTransferred" | "TransferBatch" | "TransferSingle" | "URI"): EventFragment;

    encodeFunctionData(functionFragment: 'GOLD_BADGE', values?: undefined): string;
encodeFunctionData(functionFragment: 'SILVER_BADGE', values?: undefined): string;
...
encodeFunctionData(functionFragment: 'uri', values: [BigNumberish]): string;
    ...
    decodeFunctionResult(functionFragment: 'GOLD_BADGE', data: BytesLike): Result;
decodeFunctionResult(functionFragment: 'SILVER_BADGE', data: BytesLike): Result;
...
decodeFunctionResult(functionFragment: 'uri', data: BytesLike): Result;
  ...
  removeAllListeners<TCEvent extends TypedContractEvent>(event?: TCEvent): Promise<this>
    ...
    GOLD_BADGE: TypedContractMethod<
      [],
      [bigint],
      'view'
    >
    ...
    SILVER_BADGE: TypedContractMethod<
      [],
      [bigint],
      'view'
    >
    ...
    getFunction(nameOrSignature: 'GOLD_BADGE'): TypedContractMethod<
      [],
      [bigint],
      'view'
    >;
getFunction(nameOrSignature: 'SILVER_BADGE'): TypedContractMethod<
      [],
      [bigint],
      'view'
    >;
