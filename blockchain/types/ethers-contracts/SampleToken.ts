...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener, TypedContractMethod } from "./common.js"
  ...
  export interface SampleTokenInterface extends Interface {
    getFunction(nameOrSignature: "balanceOf" | "decimals" | "name" | "symbol" | "totalSupply" | "transfer"): FunctionFragment;
...
decodeFunctionResult(functionFragment: 'transfer', data: BytesLike): Result;
  ...
  export interface SampleToken extends BaseContract {
    
    connect(runner?: ContractRunner | null): SampleToken;
